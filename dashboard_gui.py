...
class MonitorUI:
    def __init__(self, root, default_symbol=None, auto_start=False, auto_start_live=False):
        ...
        self.var_portfolio_blocked = tk.StringVar(value="-")
    ...
    def _build_layout(self):
        ...
        self._stat_cell(stats, "剔除品种", self.var_portfolio_blocked, 3, 3)
        self._stat_cell(stats, "权重方式", self.var_portfolio_method, 3, 4)
        self._stat_cell(stats, "再平衡次数", self.var_portfolio_rebalance, 3, 5)
    ...
    def _update_from_portfolio(self):
        ...
        self.var_portfolio_blocked.set(str(len(summary.get("blocked_by_corr", []))))
